...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./output_test', help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda', help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default='upocr_checkpoints/checkpoint0199.pth', help='resume from checkpoint')
    ...
    # Data parameters
    parser.add_argument('--data_cfg_paths', type=str, nargs='+', default=["data_configs/train/scut-enstext.yaml", 
                                                                          "data_configs/train/tampered-ic13.yaml", 
                                                                          "data_configs/train/textseg.yaml", 
                                                                          "data_configs/train/binarization.yaml"])
    ...
    parser.add_argument('--eval_data_cfg_path', type=str, default='data_configs/eval/zyy.yaml')
